...
const NAV = [
  ...
  { href: "/insurances", label: "Insurance", icon: ShieldCheck, perm: PERMISSIONS.INSURANCE_MANAGE, ready: true },
  ...
  { href: "/admin/settings", label: "Settings", icon: Settings, perm: PERMISSIONS.SETTING_MANAGE, ready: true },
];
