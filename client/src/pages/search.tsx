    ...
    <div className="space-y-4">
      ...
      <div className="card p-4">
        <div className="relative">
          ...
          <input
            className="h-12 w-full rounded-xl border border-slate-300 bg-white pl-12 pr-4 text-base outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20"
